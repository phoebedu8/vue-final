<template>
  <div class="container-fluid">
    <div class="row">
      <div class="about-img d-flex justify-content-center"></div>
    </div>
  </div>
  <div class="container mt-5 px-4">
    ...
    <div class="row d-flex justify-content-center">
      ...
      <div class="border-bottom my-3 mt-lg-5 about-img-border"></div>
    </div>
  </div>
  <div class="container about-img-small my-5">
