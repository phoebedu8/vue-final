<template>
  <div class="main">
    ...
    <div class="container rounded my-5">
      <div class="row mx-1 mx-md-0 cart-title-bar mx-1 mx-md-0 cart-title d-flex align-items-center justify-content-center rounded-top">
        <div class="col d-flex align-items-center justify-content-center text-white">STEP 4 : 完成購物</div>
      </div>
      <div class="row mx-1 mx-md-0 py-3 mx-md-0 border">
        <div class="col-12 text-center my-5 ">完成訂單，感謝您的購買</div>
        <div class="col-12 text-center mb-5">
          <router-link to="/">
            <div class="px-5 btn btn-outline-secondary mx-1" type="button">回到首頁</div>
          </router-link>
          <router-link to="/products">
            <div class="px-5 btn btn-outline-danger mx-1" type="button">繼續購物</div>
          </router-link>
        </div>
      </div>
    </div>
